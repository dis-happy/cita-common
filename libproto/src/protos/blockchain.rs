...
impl Transaction {
    ...
    pub fn clear_caData(&mut self) {
        self.caData.clear();
    }

    // Param is passed by value, moved
    pub fn set_caData(&mut self, v: ::std::vec::Vec<u8>) {
        self.caData = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_caData(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.caData
    }

    // Take field
    pub fn take_caData(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.caData, ::std::vec::Vec::new())
    }

    pub fn get_caData(&self) -> &[u8] {
        &self.caData
    }
}
...
impl ::protobuf::Message for Transaction {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.caData)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.caData.is_empty() {
            my_size += ::protobuf::rt::bytes_size(9, &self.caData);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "caData",
                    |m: &Transaction| { &m.caData },
                    |m: &mut Transaction| { &mut m.caData },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\x07version\x12\x16\n\x06caData\x18\t\x20\x01(\x0cR\x06caData\"\
    ...
    _list\x18\x01\x20\x03(\x0cR\tblackList\x12\x1d\n\nclear_list\x18\x02\x20\
    \x03(\x0cR\tclearList\"%\n\x0bStateSignal\x12\x16\n\x06height\x18\x01\
    \x20\x01(\x04R\x06height*2\n\tProofType\x12\x12\n\x0eAuthorityRound\x10\
