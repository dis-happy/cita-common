...
impl Transaction {
    ...
    pub fn clear_idd(&mut self) {
        self.idd = 0;
    }

    // Param is passed by value, moved
    pub fn set_idd(&mut self, v: u32) {
        self.idd = v;
    }

    pub fn get_idd(&self) -> u32 {
        self.idd
    }

    fn get_idd_for_reflect(&self) -> &u32 {
        &self.idd
    }

    fn mut_idd_for_reflect(&mut self) -> &mut u32 {
        &mut self.idd
    }
}
...
impl ::protobuf::Message for Transaction {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.idd != 0 {
            my_size += ::protobuf::rt::value_size(9, self.idd, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn descriptor_static(_: ::std::option::Option<Transaction>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "idd",
                    Transaction::get_idd_for_reflect,
                    Transaction::mut_idd_for_reflect,
                ));
...
impl BlackList {
    ...
    fn get_black_list_for_reflect(&self) -> &::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &self.black_list
    }

    fn mut_black_list_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.black_list
    }
    ...
    fn get_clear_list_for_reflect(&self) -> &::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &self.clear_list
    }

    fn mut_clear_list_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.clear_list
    }
}
    ...
    fn descriptor_static(_: ::std::option::Option<BlackList>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "black_list",
                    BlackList::get_black_list_for_reflect,
                    BlackList::mut_black_list_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "clear_list",
                    BlackList::get_clear_list_for_reflect,
                    BlackList::mut_clear_list_for_reflect,
                ));
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for StateSignal {}
...
impl StateSignal {
    ...
    pub fn default_instance() -> &'static StateSignal {
...
impl ::protobuf::MessageStatic for StateSignal {
    fn new() -> StateSignal {
        StateSignal::new()
    }

    fn descriptor_static(_: ::std::option::Option<StateSignal>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "height",
                    StateSignal::get_height_for_reflect,
                    StateSignal::mut_height_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\x07version\x12\x10\n\x03idd\x18\t\x20\x01(\rR\x03idd\"\x86\x01\
    \n\x15UnverifiedTransaction\x12.\n\x0btransaction\x18\x01\x20\x01(\x0b2\
    \x0c.TransactionR\x0btransaction\x12\x1c\n\tsignature\x18\x02\x20\x01(\
    \x0cR\tsignature\x12\x1f\n\x06crypto\x18\x03\x20\x01(\x0e2\x07.CryptoR\
    \x06crypto\"\x8e\x01\n\x11SignedTransaction\x12H\n\x14transaction_with_s\
    ig\x18\x01\x20\x01(\x0b2\x16.UnverifiedTransactionR\x12transactionWithSi\
    g\x12\x17\n\x07tx_hash\x18\x02\x20\x01(\x0cR\x06txHash\x12\x16\n\x06sign\
    er\x18\x03\x20\x01(\x0cR\x06signer\"C\n\tBlockBody\x126\n\x0ctransaction\
    s\x18\x01\x20\x03(\x0b2\x12.SignedTransactionR\x0ctransactions\"g\n\x05B\
    ...
    \x02\x08\x12\x039\x04\x13\n\r\n\x05\x04\x05\x02\x08\x04\x12\x049\x048\
    \x17\n\x0c\n\x05\x04\x05\x02\x08\x05\x12\x039\x04\n\n\x0c\n\x05\x04\x05\
    \x02\x08\x01\x12\x039\x0b\x0e\n\x0c\n\x05\x04\x05\x02\x08\x03\x12\x039\
    ...
    \x08\x19\n\x0b\n\x04\x04\x07\x02\0\x12\x03C\x043\n\r\n\x05\x04\x07\x02\0\
    \x04\x12\x04C\x04B\x1b\n\x0c\n\x05\x04\x07\x02\0\x06\x12\x
n\x0c\n\x05\x04\t\x02\x01\x01\x12\x03R\x10\x16\n\x0c\n\
    \x05\x04\t\x02\x01\x03\x12\x03R\x19\x1a\n\x0b\n\x04\x04\t\x02\x02\x12\
    \x03S\x04\x17\n\r\n\x05\x04\t\x02\x02\x04\x12\x04S\x04R\x1b\n\x0c\n\x05\
    \x04\t\x02\x02\x06\x12\x03S\x04\r\n\x0c\n\x05\x04\t\x02\x02\x01\x12\x03S\
    \x0e\x12\n\x0c\n\x05\x04\t\x02\x02\x03\x12\x03S\x15\x16\n\n\n\x02\x04\n\
    \x12\x04V\0Y\x01\n\n\n\x03\x04\n\x01\x12\x03V\x08\x16\n\x0b\n\x04\x04\n\
    \x02\0\x12\x03W\x04\x12\n\r\n\x05\x04\n\x02\0\x04\x12\x04W\x04V\x18\n\
    \x0c\n\x05\x04\n\x02\0\x06\x12\x03W\x04\t\n\x0c\n\x05\x04\n\x02\0\x01\
    \x12\x03W\n\r\n\x0c\n\x05\x04\n\x02\0\x03\x12\x03W\x10\x11\n\x0b\n\x04\
    \x04\n\x02\x01\x12\x03X\x04\x14\n\r\n\x05\x04\n\x02\x01\x04\x12\x04X\x04\
    W\x12\n\x0c\n\x05\x04\n\x02\x01\x06\x12\x03X\x04\t\n\x0c\n\x05\x04\n\x02\
    ...
    \0\x12\x03b\x04\"\x1aW\x20black\x20list\x20of\x20address,\x20the\x20acco\
    unt\x20that\x20sent\x20the\x20transaction\x20does\x20not\x20have\x20enou\
    gh\x20gas\n\n\x0c\n\x05\x04\x0c\x02\0\x04\x12\x03b\x04\x0c\n\x0c\n\x05\
    \x04\x0c\x02\0\x05\x12\x03b\r\x12\n\x0c\n\x05\x04\x0c\x02\0\x01\x12\x03b\
    \x13\x1d\n\x0c\n\x05\x04\x0c\x02\0\x03\x12\x03b\x20!\n$\n\x04\x04\x0c\
    \x02\x01\x12\x03d\x04\"\x1a\x17\x20clear\x20list\x20of\x20address\n\n\
    \x0c\n\x05\x04\x0c\x02\x01\x04\x12\x03d\x04\x0c\n\x0c\n\x05\x04\x0c\x02\
    \x01\x05\x12\x03d\r\x12\n\x0c\n\x05\x04\x0c\x02\x01\x01\x12\x03d\x13\x1d\
    \n\x0c\n\x05\x04\x0c\x02\x01\x03\x12\x03d\x20!\n&\n\x02\x04\r\x12\x04h\0\
    j\x01\x1a\x1a\x20State\x20positioning\x20signal\n\n\n\n\x03\x04\r\x01\
    \x12\x03h\x08\x13\n\x0b\n\x04\x04\r\x02\0\x12\x03i\x04\x16\n\r\n\x05\x04\
    \r\x02\0\x04\x12\x04i\x04h\x15\n\x0c\n\x05\x04\r\x02\0\x05\x12\x03i\x04\
    \n\n\x0c\n\x05\x04\r\x02\0\x01\x12\x03i\x0b\x11\n\x0c\n\x05\x04\r\x02\0\
    \x03\x12\x03i\x14\x15b\x06proto3\
";
