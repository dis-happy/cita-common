...
pub struct Request {
    ...
    pub remote_addr_ip: ::std::string::String,
...
impl Request {
    ...
    // .proto.BatchRequest batch_req = 20;
    ...
    // .proto.StateProof state_proof = 24;
    ...
    // string remote_addr_ip = 26;

    pub fn clear_remote_addr_ip(&mut self) {
        self.remote_addr_ip.clear();
    }

    // Param is passed by value, moved
    pub fn set_remote_addr_ip(&mut self, v: ::std::string::String) {
        self.remote_addr_ip = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_remote_addr_ip(&mut self) -> &mut ::std::string::String {
        &mut self.remote_addr_ip
    }

    // Take field
    pub fn take_remote_addr_ip(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.remote_addr_ip, ::std::string::String::new())
    }

    pub fn get_remote_addr_ip(&self) -> &str {
        &self.remote_addr_ip
    }
...
impl ::protobuf::Message for Request {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                26 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.remote_addr_ip)?;
                },
                27 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.remote_addr_ip.is_empty() {
            my_size += ::protobuf::rt::string_size(26, &self.remote_addr_ip);
        }
        if !self.host.is_empty() {
            my_size += ::protobuf::rt::string_size(27, &self.host);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.remote_addr_ip.is_empty() {
            os.write_string(26, &self.remote_addr_ip)?;
        }
        if !self.host.is_empty() {
            os.write_string(27, &self.host)?;
        }
        if let ::std::option::Option::Some(ref v) = self.req {
            match v {
                &Request_oneof_req::block_number(v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "remote_addr_ip",
                    |m: &Request| { &m.remote_addr_ip },
                    |m: &mut Request| { &mut m.remote_addr_ip },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "host",
                    |m: &Request| { &m.host },
                    |m: &mut Request| { &mut m.host },
                ));
...
impl BatchRequest {
    ...
    // repeated .proto.Request new_tx_requests = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\rrequest.proto\x12\x05proto\x1a\x10blockchain.proto\"V\n\x04Call\x12\
    \x12\n\x04from\x18\x01\x20\x01(\x0cR\x04from\x12\x0e\n\x02to\x18\x02\x20\
    \x01(\x0cR\x02to\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\x04data\x12\x16\
    \n\x06height\x18\x04\x20\x01(\tR\x06height\"Z\n\nStateProof\x12\x18\n\
    \x07address\x18\x01\x20\x01(\x0cR\x07address\x12\x1a\n\x08position\x18\
    \x02\x20\x01(\x0cR\x08position\x12\x16\n\x06height\x18\x03\x20\x01(\tR\
    \x06height\"\x80\x08\n\x07Request\x12\x1d\n\nrequest_id\x18\x01\x20\x01(\
    \x0cR\trequestId\x12#\n\x0cblock_number\x18\x02\x20\x01(\x08H\0R\x0bbloc\
    kNumber\x12$\n\rblock_by_hash\x18\x03\x20\x01(\tH\0R\x0bblockByHash\x12(\
    \n\x0fblock_by_height\x18\x04\x20\x01(\tH\0R\rblockByHeight\x12\"\n\x0bt\
    ransaction\x18\x05\x20\x01(\x0cH\0R\x0btransaction\x12\x18\n\x06height\
    \x18\x06\x20\x01(\x04H\0R\x06height\x12\x1e\n\tpeercount\x18\x07\x20\x01\
    (\x08H\0R\tpeercount\x12!\n\x04call\x18\x08\x20\x01(\x0b2\x0b.proto.Call\
    H\0R\x04call\x12\x18\n\x06filter\x18\t\x20\x01(\tH\0R\x06filter\x121\n\
    \x13transaction_receipt\x18\n\x20\x01(\x0cH\0R\x12transactionReceipt\x12\
    -\n\x11transaction_count\x18\x0b\x20\x01(\tH\0R\x10transactionCount\x12\
    \x14\n\x04code\x18\x0c\x20\x01(\tH\0R\x04code\x12\x12\n\x03abi\x18\r\x20\
    \x01(\tH\0R\x03abi\x12\x1f\n\nnew_filter\x18\x0e\x20\x01(\tH\0R\tnewFilt\
    er\x12*\n\x10new_block_filter\x18\x0f\x20\x01(\x08H\0R\x0enewBlockFilter\
    \x12+\n\x10uninstall_filter\x18\x10\x20\x01(\x04H\0R\x0funinstallFilter\
    \x12'\n\x0efilter_changes\x18\x11\x20\x01(\x04H\0R\rfilterChanges\x12!\n\
    \x0bfilter_logs\x18\x12\x20\x01(\x04H\0R\nfilterLogs\x12-\n\x05un_tx\x18\
    \x13\x20\x01(\x0b2\x16.UnverifiedTransactionH\0R\x04unTx\x122\n\tbatch_r\
    eq\x18\x14\x20\x01(\x0b2\x13.proto.BatchRequestH\0R\x08batchReq\x12-\n\
    \x11transaction_proof\x18\x15\x20\x01(\x0cH\0R\x10transactionProof\x12\
    \x1d\n\tmeta_data\x18\x16\x20\x01(\tH\0R\x08metaData\x12\x1a\n\x07balanc\
    e\x18\x17\x20\x01(\tH\0R\x07balance\x124\n\x0bstate_proof\x18\x18\x20\
    \x01(\x0b2\x11.proto.StateProofH\0R\nstateProof\x120\n\x13block_header_h\
    eight\x18\x19\x20\x01(\tH\0R\x11blockHeaderHeight\x12$\n\x0eremote_addr_\
    ip\x18\x1a\x20\x01(\tR\x0cremoteAddrIp\x12\x12\n\x04host\x18\x1b\x20\x01\
    (\tR\x04hostB\x05\n\x03req\"F\n\x0cBatchRequest\x126\n\x0fnew_tx_request\
    s\x18\x01\x20\x03(\x0b2\x0e.proto.RequestR\rnewTxRequests*$\n\x08BlockTa\
    g\x12\n\n\x06Latest\x10\0\x12\x0c\n\x08Earliest\x10\x01J\x92\x13\n\x06\
    \x12\x04\0\0:\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\
    \x03\x01\x08\r\n\t\n\x02\x03\0\x12\x03\x02\x07\x19\n\n\n\x02\x05\0\x12\
    \x04\x04\0\x07\x01\n\n\n\x03\x05\0\x01\x12\x03\x04\x05\r\n\x0b\n\x04\x05\
    \0\x02\0\x12\x03\x05\x04\x0f\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03\x05\x04\
    \n\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x05\r\x0e\n\x0b\n\x04\x05\0\x02\
    \x01\x12\x03\x06\x04\x11\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03\x06\x04\
    ...
    \x08\x12\n\x0b\n\x04\x04\x01\x02\0\x12\x03\x11\x04\x16\n\r\n\x05\x04\x01\
    \x02\0\x04\x12\x04\x11\x04\x10\x14\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\
    \x11\x04\t\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x11\n\x11\n\x0c\n\x05\
    \x04\x01\x02\0\x03\x12\x03\x11\x14\x15\n\x0b\n\x04\x04\x01\x02\x01\x12\
    \x03\x12\x04\x17\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\x12\x04\x11\x16\n\
    \x0c\n\x05\x04\x01\x02\x01\x05\x12\x03\x12\x04\t\n\x0c\n\x05\x04\x01\x02\
    \x01\x01\x12\x03\x12\n\x12\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x12\
    \x15\x16\n\x0b\n\x04\x04\x01\x02\x02\x12\x03\x13\x04\x16\n\r\n\x05\x04\
    \x01\x02\x02\x04\x12\x04\x13\x04\x12\x17\n\x0c\n\x05\x04\x01\x02\x02\x05\
    \x12\x03\x13\x04\n\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03\x13\x0b\x11\n\
    \x0c\n\x05\x04\x01\x02\x02\x03\x12\x03\